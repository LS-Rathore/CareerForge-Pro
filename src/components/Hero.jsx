        ...
        <section className="relative min-h-[90vh] flex items-center justify-center overflow-hidden px-6">
            ...
            <div className="relative z-10 max-w-4xl text-center">
                ...
                <div className="flex flex-col sm:flex-row items-center justify-center gap-4 mb-12 animate-fade-in-up animation-delay-600">
                    <button className="w-full sm:w-auto px-8 py-4 bg-mint hover:bg-mint/90 text-white font-bold rounded-xl shadow-lg shadow-mint/20 transition-all flex items-center justify-center gap-2 cursor-pointer hover:scale-[1.03] active:scale-[0.98]">
                        Build My Resume <span className="material-symbols-outlined">arrow_forward</span>
                    </button>
                    <button className="w-full sm:w-auto px-8 py-4 bg-transparent border border-border-ui hover:bg-surface text-text-secondary font-bold rounded-xl transition-all cursor-pointer hover:scale-[1.03] active:scale-[0.98]">
                        See Templates
                    </button>
                </div>
